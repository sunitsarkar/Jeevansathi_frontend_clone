                            ...
                            <div className="main-benifit">
                                ...
                                <div>
                                    <div className=" d-flex pb-3 mt-3">
                                        <div className="imgInfo ml-3">
                                            <img width="100%" src="https://static.jeevansathi.com/js_static/_next/static/images/Screened_Profiles-63d4c9edff8d96926cbf2d19c392be95.svg" />
                                        </div>
                                        {/* <div className="infoImg ImgPosition" ></div> */}
                                        <div className="underline ml-4"></div>
                            ...
                            <div className="featuresSection">
                                        ...
                                        <div className="featuresSection-dflex">
                                            <div className="featuresSection-Card">
                                                <div className="featuresSectionImages pt-5">
                                                    <img width="100%" src="https://static.jeevansathi.com/js_static/_next/static/images/match-hour-19b5b6122d30ef883c29f19334394835.svg"/>
                                                </div>
                                ...
                                <div className="exclusivePad">
                                    ...
                                    <div className="exclusiveList">
                                        <ul>  
                                            <li>
                                                <img width="60px" height="60px" src="https://static.jeevansathi.com/images/jsms/photo/Meet_your_advisor.svg"/>
                                            ...
                                            <li>
                                                <img width="60px" height="60px" src="https://static.jeevansathi.com/images/jsms/photo/Handpicked.svg"/>
                                    ...
                                    <h3 className="py-3">
                                        ...
                                        <ul className="matrimonial-Browse">
                                            {matrimonial.map((m1,index)=>(
                                                ...
                                                <div className={"pb-5 border-secondary "+(index>0?"border-top":"")}></div>
                                                        {m1} 
                                                        ...
                                                        {showMatrialMb==0?(
                                                            <div className="row">
                                                                {motherTongue.map((m1,index)=>(
                                                                    <div className="col-5 py-3" key={index}><div className="py-2">{m1.name}</div><div className="py-2 text-secondary">{m1.name} Brides</div><div className="text-secondary">{m1.name} Grooms</div></div>
                                                                ))}
                                                            </div>
                                                        ):
                                                        showMatrialMb==1?(
                                ...
                                <div className="seoContain">
                                    <div className="d-flex">
                                        <div className="seoLogo">
                                            <img width="100%" src="https://static.jeevansathi.com/images/jsms/photo/js_footer_logo.png"/>
                                        </div>
